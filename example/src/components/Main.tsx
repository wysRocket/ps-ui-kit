...
const filterMenuItems: ButtonMenuItem[] = [
  {
    label: "Ok",
    icon: <CheckIcon style={{color: "#FF0000"}} />,
    onClick: () => console.log("view click")
  },
  {
    label: "H1: 0",
    icon: <CheckIcon style={{color: "#FFFFFF", opacity: 0}} />,
    onClick: () => console.log("hide click")
  },
  {
    label: "Some",
    icon: <CheckIcon style={{color: "#FFFFFF", opacity: 0}} />,
    onClick: () => console.log("move click")
  }
];
...
const roomItems: ButtonMenuItem[] = [
  ...
  {
    label: "Room 3",
    icon: <CheckIcon style={{color: "#00FFFF", opacity: 0}} />,
    onClick: () => console.log("move click")
  },
  {
    label: "Room 3",
  ...
  render() {
    ...
    return (
      <VSplit size={Styles.SideBar.Size.WIDTH} style={{height: "100%"}}>
        ...
        <HSplit size={64}>
          <AppHeader
            user={{login: "admin", roles: [Auth.UserRole.SERVICE_ADMIN]}}
            ...
            <div style={{paddingLeft: Styles.Padding.L, paddingRight: Styles.Padding.L}}>
              <ContentHeader>
                ...
                <DateFilterButton
                  ...
                  onRangeChanged={this.onDateRangeChange}
                />
                ...
                <ConfirmButton
                  items={[
                    {label: "Save", onClick: this.onSave},
                    {
                      ...
                      confirm: {warning: "Are you shure?", actionText: "Of course, shure!"}
                    }
                  ]}
                  label={"Done"}
                />
              ...
              <div>
                <HGroup>
                  <DashboardChart
                    title={"Onboards"}
                    subtitle={"percent"}
                    data={{xAxisType: "datetime", xData: randomizeArray(sparklineData), yLabels}}
              ...
              <div>
                <Forms.RBGroup
                  ...
                  items={[
                    {label: "So simple", value: "one"},
                    {label: "So PIN", value: "two"}
                  ]}
                />
              </div>
              <div>
                <Forms.SimpleCheckbox
              ...
              <div style={{paddingTop: Styles.Padding.M}}>
                <AttributeComponent.BoxedViewer
                  ...
                  schemaAttribute={{
                    name: "First Name",
                    type: SchemaDomain.AttributeType.TEXT,
              ...
              <div style={{paddingTop: Styles.Padding.M}}>
                <AttributeComponent.Editor
                  ...
                  schemaAttribute={{
                    name: "Age",
                    type: SchemaDomain.AttributeType.NUMBER,
              ...
              <div style={{paddingTop: Styles.Padding.M}}>
                <AttributeComponent.Editor
                  ...
                  schemaAttribute={{
                    name: "Date of birth",
                    type: SchemaDomain.AttributeType.DATE,
              ...
              <div style={{paddingTop: Styles.Padding.M}}>
                <AttributeComponent.Editor
                  ...
                  schemaAttribute={{
                    name: "Sex",
                    type: SchemaDomain.AttributeType.CUSTOM_TYPE,
                    enumValues: [
                  ...
                  attributes={[
                    {
                      attribute: {
                        ...
                        value:
                          "let's imagine that you can use the same time right now because this video is not available for remote playback of new Hunter service\nArturito!\nYou are bandito!\nGangsterito!"
                      },
                      schemaField: {
                        name: "Some strange attribute with very very very long name or and some question why? Because f#ck you, that because",
                        type: SchemaDomain.AttributeType.TEXT,
                    ...
                    },
                    {
                      attribute: {
                        ...
                        value:
                          "from your message is not open app after the same time right in front of new posts via email or call me at the moment and I will check it on the other side"
                      },
                      schemaField: {
                        name: "Yet anotner question about, hm, about what? May be about your life?",
                        type: SchemaDomain.AttributeType.TEXT,
                    ...
                    },
                    {
                      attribute: {
                        ...
                        value:
                          "some people have recommended for remote playback you mean the same time as the moment and tube ids in the other hand if you have any questions"
                      },
                      schemaField: {
                        name: "Somtimes i think, that we are on the wrong way, May be we need more motivation stimulaition and suceed success? Or common and dance? Or somesthing like what?",
                        type: SchemaDomain.AttributeType.TEXT,
                    ...
                    },
                    {
                      attribute: {
                        name: "Prism DID",
                        value:
                          "fg58fdgN56786jktyuitui45uiuyifghjdfdhlfj34523452ljlertnsdfkjglsadfghskdfjgskdfjg4352345fgkljsdfhgkdjfgkhsg345325"
                      },
                      schemaField: {
                        name: "Prism DID",
                        type: SchemaDomain.AttributeType.TEXT,
              ...
              <div style={{paddingTop: 24}}>
                <ActionInstanceContainer
                  ...
                  parameters={[
                    {
                      name: "Lection",
                      value: "Mathematic Analyse and Something else, i event do not know"
                    },
              ...
              <TabbedPanel
                tabItems={[
                  {label: "One Credentials", value: 1, link: "one"},
                  {label: "Two Schemas", value: 2, link: "two"},
                  {label: "Tree", value: 3, link: "tree"}
                ]}
              ...
              <TableWithPagination
                columns={[
                  idLink((item: any) => item.identity, {
                    title: "name",
                    styleSource: (item: any) => {
