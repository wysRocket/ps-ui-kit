...
export const AppHeader: FC<IProps> = ({
  style, user, menuItems, notifications, children, onFilterChange, filterPlaceholder, onSwitchSidebarMode
}) => {

    const filterHandler = (f: string) => onFilterChange !== undefined ? onFilterChange(f) : console.log(f);
