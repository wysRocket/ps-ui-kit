...
export const editColumn = (): ColumnInfo => {
  return {
    ...
    isEdit: true,
    renderer: (props: RendererProps) => (
      <EditActionRenderer item={props.item} value={props.value} onClick={props.onClick} />
    )
  };
};
...
export const deleteColumn = (): ColumnInfo => {
  return {
    ...
    isRemove: true,
    renderer: (props: RendererProps) => (
      <DeleteActionRenderer item={props.item} value={props.value} onClick={props.onClick} />
    )
  };
};
